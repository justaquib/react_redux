        ...
        <div className="h-screen md:flex justify-center items-center bg-login md:py-24">
            <div className="flex md:w-1/4 min-h-full flex-wrap rounded-2xl border-white border-2 shadow-lg justify-center py-10 items-center bg-slate-50">
                <form className="flex flex-col items-center justify-center" ref={formRef}>
                    <h1 className="text-gray-800 font-normal text-3xl mb-1">Let's Sign Up</h1>
                    <p className="text-sm font-normal text-center text-gray-600">Explore more by <br/>connecting with us</p>
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                        ...
                        <input className="pl-2 outline-none border-none" type="password" name="password" id="" placeholder="Confirm Password" />
                    </div>
                    <button type="button" onClick={() => signIn()} className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Login</button>
