    ...
    <>
        <div className="h-screen md:flex">
            <div
                ...
                <div className=''>
                    <h1 className="text-white font-bold text-4xl font-sans">Aurotus Pvt Ltd</h1>
                    <p className="text-white mt-1">The most flexible application for your business</p>
            ...
            <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
                <form className="bg-white" ref={formRef}>
                    ...
                    <div className='flex flex-row justify-between'>
                        <span className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Sign up</span>
