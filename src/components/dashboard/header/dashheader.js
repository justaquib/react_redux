...
import RightHeaderComponent from './right/rightHeaderComponent';
import LeftHeaderComponent from './left/leftHeaderComponent';
...
export default function DashHeader(props) {
  ...
  const getLeftCallBack = props.toggleLside;
  return (
    <>
        <header className={`bg-white w-full z-50 border border-b-2 top-0 ${sticky.isSticky ? ' sticky' : ''}`} id="sticky-header" ref={headerRef}>
            <nav className="mx-auto flex max-w-full items-center justify-between p-2 lg:px-4" aria-label="Global">
                <LeftHeaderComponent toggleLside={getLeftCallBack} />
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <div className="relative">
                        <button type="button" onClick={() => handleToggle()} className="flex items-center gap-x-1text-sm font-semibold leading-6 text-gray-900 text-sm" aria-expanded="false">
                            Product
...

                        {
                            ...
                            <div className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5">
                                <div className="p-4">
                                    ...
                                    <div className="flex-auto">
                                        <a href="/chat" className="block font-semibold text-gray-900">
                                        Engagement
                                        <span className="absolute inset-0"></span>
                                        </a>
                    ...
                    <a href="/projects" className="text-sm font-semibold leading-6 text-gray-900">Project</a>
                </div>
            ...
            <div className="lg:hidden" role="dialog" aria-modal="true">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span className="sr-only">Chandan Database</span>
                    <Image
                            src="/logo.png"
                            alt="BrandLogo"
                            className="dark:invert rounded-xl h-8 w-auto"
                            width={100}
                            height={24}
                            priority
                        />
                ...
                <div className="mt-6 flow-root">
                    ...
                    <div className="space-y-2 py-6">
                        <div className="-mx-3">
                        <button type="button" onClick={()=> handleToggle()} className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 hover:bg-gray-50" aria-controls="disclosure-1" aria-expanded="false">
                            Product
                    ...
                    <div className="py-6">
                        <a href="#" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50" onClick={handleToggle}>Log in</a>
                    </div>
                    </div>
                </div>
                </div>
